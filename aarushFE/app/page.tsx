        ...
        <header className="bg-white shadow-sm sticky top-0 z-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Avatar>
                <AvatarImage src="./placeholder.png?height=32&width=32" alt="@username" />
          ...
          <div className="max-w-7xl mx-auto space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div>
                ...
                >
                  <SelectTrigger className="w-full border-gray-300 text-black bg-white">
            ...
            <div className="flex items-center justify-between">
              ...
              <Button 
                ...
                className="text-black border-gray-300 hover:bg-gray-200 hover:border-gray-400 transition-colors duration-200"
              >
                Clear Filters
              </Button>
            </div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value={activeTab} className="mt-6 space-y-6">
              {displayedOpportunities.map((opp) => (
                <Card key={opp.id} className="overflow-hidden transition-shadow duration-300 hover:shadow-lg rounded-lg">
                ...
                <CardContent className="pt-4 rounded-b-lg">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Badge variant="secondary" className="bg-purple-100 text-purple-800 rounded-full">{opp.type}</Badge>
                    <Badge variant="secondary" className="bg-indigo-100 text-indigo-800 rounded-full">{opp.experience}</Badge>
                    {opp.tags.map((tag) => (
                      <Badge key={tag} variant="outline" className="text-gray-700 rounded-full">{tag}</Badge>
                    ))}
                  </div>
                </CardContent>
                <CardFooter className="flex justify-between bg-gray-50 rounded-b-lg">
                  <Button 
                    variant="outline" 
                    size="sm"
                    className="text-black border-gray-300 hover:bg-gray-200 hover:border-gray-400 transition-colors duration-200 rounded-full"
                  >
                    Learn More
                  </Button>
                    ...
                    <aside className="w-80 bg-white shadow-lg p-6 hidden lg:block">
                      ...
                      <ul className="space-y-4">
                        <li className="flex items-center space-x-3 bg-indigo-50 p-3 rounded-lg">
                          <Avatar>
                            <AvatarImage src="./placeholder.png?height=32&width=32" alt="Jane Doe" />
                        ...
                        <li className="flex items-center space-x-3 bg-indigo-50 p-3 rounded-lg">
                          <Avatar>
                            <AvatarImage src="./placeholder.png?height=32&width=32" alt="John Smith" />
